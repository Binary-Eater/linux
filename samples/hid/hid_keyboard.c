...
/* Copyright (c) 2023 Rahul Rameshbabu
 *
 * This is a pure HID-BPF example, and should be considered as such:
 * on any GD keyboard, two keys will be swapped. On any other
 * device... Not sure what this will do.
 *
...
static int get_hid_id(const char *path)
{
	...
	str_id = dir + sizeof("XXXX:XXXX:XXXX.");
